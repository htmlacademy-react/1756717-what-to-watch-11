    ...
    <div className="film-card__text film-card__row">
      <div className="film-card__text-col">
        ...
        <p className="film-card__details-item">
          ...
          <span className="film-card__details-value" style={{ whiteSpace: 'pre-wrap' }}>
            {getColumnList(film.starring)}
          </span>
        </p>
      </div>
      ...
      <div className="film-card__text-col">
        <p className="film-card__details-item">
          ...
          <span className="film-card__details-value">{getFormatDetailsFilmRunTime(film.runTime)}</span>
        </p>
        <p className="film-card__details-item">
